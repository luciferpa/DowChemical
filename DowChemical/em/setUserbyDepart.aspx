<%@ Page Title="Home Page" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="setUserbyDepart.aspx.vb" Inherits="DowChemical.setUserbyDepart" %>
                        ...
                        <telerik:RadPanelBar ID="RadPanelBar1" runat="server" Skin="Bootstrap" Width="100%" CssClass="LeelawadeeFont">
                            <Items>
                                ...
                                <telerik:RadPanelItem runat="server" Text="REPORT" Height="36px" NavigateUrl="~/Report/rpOverallPerformance.aspx" PreventCollapse="True">
                                    <Items>
                                        <telerik:RadPanelItem runat="server" Height="28px" Text="Overall Performance">
                                        </telerik:RadPanelItem>
                                ...
                                <telerik:RadPanelItem runat="server" Text="SETTING" Height="36px" Expanded="True" PreventCollapse="True" Selected="true">
                                    <Items>
                                        <telerik:RadPanelItem runat="server" Text="USER / EMPLOYEE" NavigateUrl="~/em/setUserbyDepart.aspx?sel=setuserd" Selected="true">
                                        </telerik:RadPanelItem>
                    ...
                    <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" Width="100%">
                        <telerik:RadPageView ID="RadPageView1" runat="server">
                            <div class="row" style="padding: 32px 16px 3px 3px">
                                <div style="display: block; float: left; width: 160px; text-align: right; margin-top: 6px;">
                                    Dow ID
                                </div>
                                <div class="col-md-8">
                            ...
                            <div class="row" style="padding: 3px 16px 3px 3px">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div style="display: block; float: left; width: 100px; text-align: right; margin-top: 6px;">
                                        Surname
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="row" style="padding: 12px 16px 4px 2px">
                                <div style="display: block; float: left; width: 164px; text-align: right; margin-top: 6px;">
                                    &nbsp;
                                </div>
                                <div class="col-md-8">
                            ...
                            <div>
                                <div style="padding: 0px 0px 2px 16px; color: #282828; font-size: 1.2em; font-weight: bold; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #CCCCCC;">
                                    Last Employeee
                                </div>
                                ...
                                <asp:SqlDataSource ID="srcEmployeeLast" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>"
                                    SelectCommand="SELECT TOP (5) dbo.tblEmployee.empId, dbo.tblEmployee.empDowId, dbo.tblEmployee.empName, dbo.tblEmployee.empSurname, dbo.tblEmployee.empEmail, dbo.tblEmployee.empContact, dbo.tblEmployee.empMobile, dbo.tblEmployee.joblvCode, dbo.tblEmployee.empEnable, dbo.tblEmployee.IsSetLogin, dbo.tblEmployee.userName, dbo.tblEmployee.typeId, dbo.tblEmployee.aspNetUserId, dbo.tblEmployee.empFullName, dbo.tblEmployee.empDisplay, dbo.tblEmployee.departId FROM dbo.tblEmployee INNER JOIN dbo.tblDepartment ON dbo.tblEmployee.departId = dbo.tblDepartment.departId WHERE (dbo.tblDepartment.departId = @departId) ORDER BY dbo.tblEmployee.empId DESC">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="hfDepartId" Name="departId" PropertyName="Value" />
                                    </SelectParameters>
                                </asp:SqlDataSource>
                            </div>
                        </telerik:RadPageView>
                        <telerik:RadPageView ID="RadPageView2" runat="server">
                            <div class="row" style="padding: 8px 16px 4px 16px;">
                                <div style="display: block; float: left; width: 92px; text-align: right; margin-top: 6px;">
                                    Search
                                </div>
                                <div style="display: block; float: left; width: 27px; margin-top: 0px; padding-left: 6px;">
                                    <img alt="" src="../Images/search-28-normal.png" />
                                </div>
                                <div class="col-md-8">
                                    <div style="display: block; float: left; width: 274px;">
                                        <asp:TextBox ID="tbSearchKeyword" runat="server" CssClass="form-control input-sm" Width="266px"></asp:TextBox>
                                    </div>
                                    ...
                                    <div style="display: block; float: left; width: 32px; margin-top: 3px; margin-left: 352px; position: absolute">
                                        <asp:ImageButton ID="imgbClearKeyword" runat="server" ImageUrl="~/Images/bt_close-24.png" ToolTip="clear" Visible="false" />
                                    </div>
                                </div>
                            </div>
                            <div>
                                <telerik:RadGrid ID="rgEmployeeList" runat="server" Skin="Metro" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" GroupPanelPosition="Top" Width="100%" DataSourceID="srcEmployee" PageSize="50">
                                    <MasterTableView DataKeyNames="empId" DataSourceID="srcEmployee">
                                        <EditItemTemplate></EditItemTemplate>
                                        <NoRecordsTemplate>
                                            <div style="padding: 13px 0 30px 24px">&nbsp;</div>
                                        </NoRecordsTemplate>
                                                ...
                                                <ItemTemplate>
                                                    <div style="position: relative; top: 2px; padding-left: 8px;">
                                                        ...
                                                        <span style="padding-left: 48px">
                                                            <asp:ImageButton ID="imgbDel" runat="server" ImageUrl="~/Images/bt_delete-24.png" OnClientClick="javascript:if(!confirm('&nbsp;&nbsp;&nbsp;&nbsp;Confirm Delete?')){return false;}" ToolTip="delete employee" CommandName="Delete" Visible="False" />
                                                        </span>
                                                    </div>
                                                </ItemTemplate>
                                                <HeaderStyle Width="180px" HorizontalAlign="Left" />
                                            ...
                                            <FormTemplate>
                                                <div style="width: 100%; border-top-style: solid; border-top-width: 1px; border-top-color: #999999;">
                                                    <div class="row" style="padding: 18px 16px 3px 5px">
                                                        <div style="display: block; float: left; width: 140px; text-align: right; margin-top: 6px;">
                                                            Dow ID
                                                        </div>
                                                        <div class="col-md-8">
                                                    ...
                                                    <div class="row" style="padding: 3px 16px 3px 5px">
                                                        ...
                                                        <div class="col-md-8">
                                                            <telerik:RadComboBox ID="rcbEditDepart" runat="server" SelectedValue='<%# Bind("departId") %>' DataSourceID="srcDepartment" DataTextField="departName" DataValueField="departId" Skin="Metro" Width="172px">
                                                            </telerik:RadComboBox>
                                                            <asp:SqlDataSource ID="srcDepartment" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT departId, departName FROM tblDepartment"></asp:SqlDataSource>
                                                        </div>
                                                    </div>
                                ...
                                <asp:SqlDataSource ID="srcEmployee" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>"
                                    SelectCommand="SELECT dbo.tblEmployee.empId, dbo.tblEmployee.empDowId, dbo.tblEmployee.empName, dbo.tblEmployee.empSurname, dbo.tblEmployee.empEmail, dbo.tblEmployee.empContact, dbo.tblEmployee.empMobile, dbo.tblEmployee.joblvCode, dbo.tblEmployee.empEnable, dbo.tblEmployee.IsSetLogin, dbo.tblEmployee.userName, dbo.tblEmployee.typeId, dbo.tblEmployee.aspNetUserId, dbo.tblEmployee.empFullName, dbo.tblEmployee.empDisplay, dbo.tblDepartment.departName, dbo.tblEmployee.departId FROM dbo.tblEmployee INNER JOIN dbo.tblDepartment ON dbo.tblEmployee.departId = dbo.tblDepartment.departId WHERE (dbo.tblDepartment.departId = @departId)"
                        ...
                        <telerik:RadPageView ID="RadPageView3" runat="server">
                            ...
                            <telerik:RadMultiPage ID="RadMultiPage2" runat="server" SelectedIndex="0" Width="100%">
                                <telerik:RadPageView ID="RadMultiPage2_Create" runat="server">
                                    <div style="padding: 16px 0 2px 16px; color: #282828; font-size: 1.2em; font-weight: bold; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #CCCCCC;">
                                    ...
                                    <div style="padding: 16px 0px 0px 0px; color: #282828; background-color: #ffeded">
                                        <div class="row" style="padding: 3px 16px 3px 3px;">
                                            ...
                                            <div class="col-md-8">
                                                <div style="display: block; float: left; width: 274px;">
                                                    <telerik:RadComboBox ID="rcbAccountType" runat="server" Skin="Metro" Width="172px" DataSourceID="srcAccountType" DataTextField="typeName" DataValueField="typeId">
                                                    </telerik:RadComboBox>
                                    ...
                                    <div style="padding: 16px 0 0 178px;">
                                    </div>
                                </telerik:RadPageView>
                                <telerik:RadPageView ID="RadMultiPage2_Change" runat="server">
                                    ...
                                    <div style="padding: 16px 0px 0px 0px; color: #282828; background-color: #ffeded">
                                        <div class="row" style="padding: 3px 16px 3px 3px;">
                                            ...
                                            <div class="col-md-8">
                                                <div style="display: block; float: left; width: 274px;">
                                                    <telerik:RadComboBox ID="rcbAccountType_Change" runat="server" Skin="Metro" Width="172px" DataSourceID="srcAccountType" DataTextField="typeName" DataValueField="typeId">
                                                    </telerik:RadComboBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" style="padding: 3px 16px 3px 3px;">
                                            ...
                                            <div class="col-md-8">
                                                <div style="display: block; float: left; width: 274px;">
                                                    <asp:TextBox ID="tbUsername_Change" runat="server" CssClass="form-control input-sm" Width="266px"></asp:TextBox>
                                                    <asp:HiddenField ID="hfUsername_Ori" runat="server" />
                                ...
                                <telerik:RadPageView ID="RadMultiPage2_Reset" runat="server">
                                    <div style="padding: 16px 0 2px 16px; color: #CC0000; font-size: 1.2em; font-weight: bold; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #CCCCCC;">
                                        Reset your account
                                    </div>
                                    <div style="padding: 16px 0px 0px 0px; color: #282828; background-color: #ffeded">
                                        <div class="row" style="padding: 3px 16px 3px 3px;">
                                ...
                                <telerik:RadPageView ID="RadMultiPage2_Delete" runat="server">
                                    ...
                                    <div style="padding: 16px 0px 0px 0px; color: #282828; background-color: #ffeded">
                                        ...
                                        <div style="padding: 24px 0 2px 178px; font-size: 1.1em; font-weight: 600; border-bottom-style: solid; border-bottom-width: 3px; border-bottom-color: #E4E4E4;">
