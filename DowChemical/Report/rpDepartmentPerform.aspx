<%@ Page Title="Home Page" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rpDepartmentPerform.aspx.vb" Inherits="DowChemical.rpDepartmentPerform" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <div id="f-header-setting" style="font-size: 1.6em; padding: 8px 0 0 16px;">EZ Path Observation by Department</div>
                            ...
                            <Items>
                                ...
                                <telerik:RadPanelItem runat="server" Text="REPORT" Height="36px" Expanded="True" PreventCollapse="True" Selected="true">
                                    <Items>
                                        ...
                                        <telerik:RadPanelItem runat="server" Height="28px" Text="Performance by Department" NavigateUrl="~/Report/rpDepartmentPerform.aspx" Selected="true">
                                        </telerik:RadPanelItem>
                ...
                <div id="content">
                    <div class="row LeelawadeeFont">
                        <div style="border-style: none none solid none; height: 63px; border-bottom-color: #DDDDDD; border-bottom-width: 1px; padding-top: 12px; padding-right: 0px; padding-left: 0px;">
                            <div class="row" style="padding: 0px 6px 0px 0px; margin-right: -15px">
                                <div class="col-md-8">
                                    ...
                                    <div style="display: block; float: left; width: 180px; padding-top: 8px; padding-left: 8px;">
                                                    ...
                                                    <ContentTemplate>
                                                        <div class="form-horizontal" style="padding: 8px 12px 0 12px; width: 280px">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <asp:CheckBox ID="chkShowPsceContainment" runat="server" CssClass="chkBT2m" Text="&nbsp;&nbsp;&nbsp;PSCE_Containment Loss Near Miss" Checked="False" Enabled="false" />
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-3">&nbsp;</div>
                                                                <div class="col-md-9">
                                                                    <asp:CheckBox ID="chkShowPscePsnm" runat="server" CssClass="chkBT2m" Text="&nbsp;&nbsp;&nbsp;PSCE_PSNM Near Miss" Checked="False" Enabled="false" />
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-3">&nbsp;</div>
                                                                <div class="col-md-9">
                                                                    <asp:CheckBox ID="chkShowActionCompleted" runat="server" CssClass="chkBT2m" Text="&nbsp;&nbsp;&nbsp;% Action Completed" Checked="False" Enabled="false" />
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-3">&nbsp;</div>
                                                                <div class="col-md-9">
                                                                    <asp:CheckBox ID="chkShowFieldVisibility" runat="server" CssClass="chkBT2m" Text="&nbsp;&nbsp;&nbsp;% Field Visibility" Checked="False" Enabled="false" />
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-3">&nbsp;</div>
                                                                <div class="col-md-9">
                                                                    <asp:CheckBox ID="chkShowProactiveCompliance" runat="server" CssClass="chkBT2m" Text="&nbsp;&nbsp;&nbsp;Proactive Compliance" Checked="False" Enabled="false" />
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-3">&nbsp;</div>
                                                                <div class="col-md-9">
                                                                    <asp:CheckBox ID="chkShowSecondEye" runat="server" CssClass="chkBT2m" Text="&nbsp;&nbsp;&nbsp;2nd EYE Participation" Checked="true" Enabled="true" />
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-3">&nbsp;</div>
                        ...
                        <div class="row" style="margin-top: 1px; padding-bottom: 1px; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-color: #DDDDDD;">
                            ...
                            <div class="col-md-12" style="padding: 16px 32px 24px 16px;">
                                <div class="row">
                                    <div class="col-md-1">
                                    </div>
                                    <div class="col-md-10">
                                        <telerik:RadHtmlChart ID="RadHtmlChart1" runat="server" Skin="Bootstrap">
                                            <ChartTitle Text="PSCE _Containment Loss Near Miss by Department - YTD"></ChartTitle>
                                            <PlotArea>
                                                <Series>
                                                    ...
                                                    <telerik:LineSeries DataFieldY="goalPSCE_ContainmentLoss" Name="goalPSCE_ContainmentLoss" Visible="true">
                                                ...
                                                <XAxis DataLabelsField="departName">
                            ...
                            <div class="col-md-12" style="padding: 8px 32px 24px 16px;">
                                <div class="row">
                                    <div class="col-md-1">
                                    </div>
                                    <div class="col-md-10">
                                        <telerik:RadHtmlChart ID="RadHtmlChart2" runat="server" Skin="Bootstrap">
                                            <ChartTitle Text="PSCE_PSNM by Department - YTD"></ChartTitle>
                                            <PlotArea>
                                                <Series>
                                                    ...
                                                    <telerik:LineSeries DataFieldY="goalPSCE_PSNM" Name="goalPSCE_PSNM" Visible="true">
                                                        <LineAppearance Width="0" />
                                                        <MarkersAppearance MarkersType="Circle" BackgroundColor="White" Size="6" BorderColor="#ff0000" BorderWidth="2"></MarkersAppearance>
                                                        <TooltipsAppearance BackgroundColor="Red" Color="White"></TooltipsAppearance>
                                                        <Appearance>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <telerik:RadHtmlChart ID="RadHtmlChart3" runat="server" Skin="Bootstrap">
                                            <ChartTitle Text="% Action Completed - YTD"></ChartTitle>
                                            <PlotArea>
                                                <Series>
                                                ...
                                                <XAxis DataLabelsField="departNameMTP">
                                                    <LabelsAppearance RotationAngle="300">
                                                    </LabelsAppearance>
                                                    <TitleAppearance Text="">
                                                    </TitleAppearance>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <telerik:RadHtmlChart ID="RadHtmlChart4" runat="server" Skin="Bootstrap">
                                            <ChartTitle Text="% Field Visibility - YTD"></ChartTitle>
                                            <PlotArea>
                                                <Series>
                                                ...
                                                <YAxis>
                                                    <LabelsAppearance DataFormatString="{0:0.0 %}"></LabelsAppearance>
                                                </YAxis>
                                            </PlotArea>
                                            <Legend>
                                                <Appearance Visible="false" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <telerik:RadHtmlChart ID="RadHtmlChart11" runat="server" Skin="Bootstrap">
                                            <ChartTitle Text="% Opportunity Identified (OFI) - YTD"></ChartTitle>
                                            <PlotArea>
                                                <Series>
                            ...
                            <div class="col-md-12" style="padding: 8px 32px 32px 16px;">
                                <div class="row">
                                    <div class="col-md-1">
                                    </div>
                                    <div class="col-md-10">
                                        <telerik:RadHtmlChart ID="RadHtmlChart14" runat="server" Skin="Bootstrap">
                                            <ChartTitle Text="% Off Hour Participation - YTD"></ChartTitle>
                                            <PlotArea>
                                                <Series>
