<%@ Page Title="Home Page" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="setGoal.aspx.vb" Inherits="DowChemical.setGoal" %>
                    ...
                    <div class="row LeelawadeeFont">
                        <div style="border-style: none none solid none; height: 63px; border-bottom-color: #DDDDDD; border-bottom-width: 1px; padding-top: 12px; padding-right: 0px; padding-left: 0px;">
                            <div class="row">
                                ...
                                <div style="display: block; float: left; width: 188px; padding-top: 8px; padding-left: 8px;">
                                </div>
                                <div style="text-align: right; padding-right: 24px; padding-top: 15px;">
                                    <asp:CheckBox ID="chkUpdateAllYear" runat="server" Text="&nbsp;&nbsp;update all month" CssClass="chkBT2m" Font-Size="1em" Checked="true" />
                                </div>
                            </div>
                        </div>
                        <div>
                                ...
                                <MasterTableView DataKeyNames="departId" DataSourceID="srcDepartmentList">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn UniqueName="TemplateColumn">
                                            <HeaderTemplate>
                                                <div style="display: block; float: left; width: 11%; text-align: center;">
                                                    2nd Eye<br />
                                                    Safety Review<br />
                                                    Participation
                                                </div>
                                                <div style="display: block; float: left; width: 13%; text-align: center; margin-top: 7px;">
                                                    PSCE_Containment<br />
                                                    Loss Near miss (L5)
                                                </div>
                                                <div style="display: block; float: left; width: 12%; height: 24px; vertical-align: middle; text-align: center; margin-top: 16px;">
                                                    PSCE_PSNM (L5)
                                                </div>
                                                ...
                                                <div style="display: block; float: left; width: 8.5%; text-align: center; margin-top: 7px;">
                                                    % Action<br />
                                                    Complete
                                                </div>
                                                <div style="display: block; float: left; width: 10%; text-align: center;">
                                                    Compliance<br />
                                                    Proactive<br />
                                                    Report
                                                </div>
                                                <div style="display: block; float: left; width: 8.5%; text-align: center; color: brown; margin-top: 7px;">
                                                    FSFL Users<br />
                                                    (fsfl)
                                                </div>
                                                <div style="display: block; float: left; width: 9.5%; text-align: center; color: brown; margin-top: 7px;">
                                                    TECH Users<br />
                                                    (tech)
                                                </div>
                                                <div style="display: block; float: left; width: 15.5%; height: 24px; vertical-align: middle; text-align: center; margin-top: 16px;">
                                                    <div style="text-align: left;">Last Update</div>
                                                </div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:HiddenField ID="hfDepartId" runat="server" Value='<%# Eval("departId") %>' />
                                                <div style="display: block; float: left; width: 11%;">
                                                    <asp:Label ID="lb_secondEyeSafety" runat="server" Text='<%#String.Format("{0:N0}", "0") %>'></asp:Label>
                                                </div>
                                                ...
                                                <div style="display: block; float: left; width: 8.5%;">
                                                ...
                                                <div style="display: block; float: left; width: 10%;">
                                                    <asp:Label ID="lb_complianceProactive" runat="server" Text='<%#String.Format("{0:N0}", "0") %>'></asp:Label>
                                                </div>
                                                <div style="display: block; float: left; width: 8.5%;">
                                                    <asp:Label ID="lb_fsflUser" runat="server" Text='<%#String.Format("{0:N0}", "0") %>'></asp:Label>
                                                </div>
                                                <div style="display: block; float: left; width: 9.5%;">
                                                    <asp:Label ID="lb_techUser" runat="server" Text='<%#String.Format("{0:N0}", "0") %>'></asp:Label>
                                                </div>
                                                <div style="display: block; float: left; width: 15.5%;">
                                            ...
                                            <FooterTemplate>
                                                <div style="display: block; float: left; width: 11%;">
                                                    <asp:Label ID="lbFooter_secondEyeSafety" runat="server" Text='<%#String.Format("{0:N0}", "0") %>'></asp:Label>
                                                </div>
                                                <div style="display: block; float: left; width: 13%;">
                                                ...
                                                <div style="display: block; float: left; width: 10%;">
                                                    <asp:Label ID="lbFooter_complianceProactive" runat="server" Text='<%#String.Format("{0:N0}", "0") %>'></asp:Label>
                                                </div>
                                                <div style="display: block; float: left; width: 8.5%;">
                                                ...
                                                <div style="display: block; float: left; width: 15.5%;">&nbsp;</div>
                                            </FooterTemplate>
                                                ...
                                                <div class="row editc1">
                                                    ...
                                                    <div class="col-md-11" style="padding-top: 8px;">
                                                        <div class="row editc1">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div style="display: block; float: left; width: 200px;">
                                                                    <telerik:RadNumericTextBox ID="tbn_secondEyeSafety" runat="server" CssClass="form-control input-sm edittbnumber" Width="200px" NumberFormat-DecimalDigits="1"></telerik:RadNumericTextBox>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row editc1">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div style="display: block; float: left; width: 200px;">
                                                                    <telerik:RadNumericTextBox ID="tbn_PSCE_ContainmentLoss" runat="server" CssClass="form-control input-sm edittbnumber" Width="200px" NumberFormat-DecimalDigits="1"></telerik:RadNumericTextBox>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row editc1">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div style="display: block; float: left; width: 200px;">
                                                                    <telerik:RadNumericTextBox ID="tbn_PSCE_PSNM" runat="server" CssClass="form-control input-sm edittbnumber" Width="200px" NumberFormat-DecimalDigits="1"></telerik:RadNumericTextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row editc1">
                                                        ...
                                                        <div class="row editc1">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div style="display: block; float: left; width: 200px;">
                                                                    <telerik:RadNumericTextBox ID="tbn_complianceProactive" runat="server" CssClass="form-control input-sm edittbnumber" Width="200px" NumberFormat-DecimalDigits="1"></telerik:RadNumericTextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                        ...
                        <asp:Panel ID="pnEditMTP" runat="server" Visible="false">
                            <div class="row" style="padding-top: 8px; padding-bottom: 4px;">
                                <div style="padding-left: 144px;">
                                    <div style="display: block; float: left; width: 35%;">&nbsp;</div>
                                    <div style="display: block; float: left; width: 12%;">
                        ...
                        <asp:HiddenField ID="hftotalSecondEyeSafety" runat="server" Value="0" />
                        <asp:HiddenField ID="hftotalPSCE_ContainmentLoss" runat="server" Value="0" />
                        <asp:HiddenField ID="hftotalPSCE_PSNM" runat="server" />
                        <asp:HiddenField ID="hfcomplianceProactive" runat="server" Value="0" />
                    </div>
                </div>
            </ContentTemplate>
        </asp:UpdatePanel>
