        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div style="color: dimgray; font-size: 1.3em; padding: 48px 0 0 32px;">
                    <asp:HyperLink ID="HyperLink1" runat="server" Target="_blank" NavigateUrl="http://maptaphut.intranet.dow.com/ResponsibleCare/EZPath.htm">Basics EZ Path Tool Guidelines</asp:HyperLink>
                </div>
