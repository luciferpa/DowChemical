<%@ Page Title="Home Page" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="export2ExcelChkEmp.aspx.vb" Inherits="DowChemical.export2ExcelChkEmp" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <div class="row LeelawadeeFont">
                <div class="col-md-12" style="padding: 0px 6px 0px 0px;">
                    <div style="text-align: right; padding-right: 12px; padding-top: 8px;">                        
                        <asp:Button ID="btExportExcel2" runat="server" Height="30px" class="btn btn-default btn-mo30" Text="Export to Excel File" Width="150px" />
                    </div>
                    <div>tblRecord <asp:Label ID="Label11" runat="server" Text="Label"></asp:Label></div>
                    <asp:SqlDataSource ID="SqlDataSource11" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT DISTINCT empId FROM tblRecord WHERE (empId &lt;&gt; 0) ORDER BY empId"></asp:SqlDataSource>
                    <telerik:RadGrid ID="RadGrid11" runat="server" GroupPanelPosition="Top" Skin="Metro" Height="300px" DataSourceID="SqlDataSource11">
                        <GroupingSettings CollapseAllTooltip="Collapse all groups" />
                        <ClientSettings>
                            <Scrolling AllowScroll="True" UseStaticHeaders="True" />
                        </ClientSettings>
                        <MasterTableView AutoGenerateColumns="False" DataSourceID="SqlDataSource11">
                            <CommandItemSettings ShowExportToExcelButton="false" ShowAddNewRecordButton="false" ShowRefreshButton="false" />
                            <NoRecordsTemplate>
                                <div style="padding: 13px 0 30px 24px">&nbsp;</div>
                            </NoRecordsTemplate>
                            <Columns>
                                <telerik:GridBoundColumn DataField="empId" HeaderText="empId" UniqueName="empId" DataType="System.Int32" FilterControlAltText="Filter empId column" SortExpression="empId">
                                </telerik:GridBoundColumn>
                                <telerik:GridTemplateColumn DataType="System.Int32" FilterControlAltText="Filter empId column" HeaderText="empId" SortExpression="empId" UniqueName="empIdDetail">
                                    <ItemTemplate>
                                        <asp:HiddenField ID="hfEmpId" runat="server" Value='<%# Eval("empId") %>' />
                                        <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT recId, departId, recActNo, recActMonth FROM tblRecord WHERE (empId = @empId)">
                                            <SelectParameters>
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="recId" DataSourceID="SqlDataSource1">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="recActNo" HeaderText="recActNo" SortExpression="recActNo" />
                                                <asp:BoundField DataField="recActMonth" HeaderText="recActMonth" SortExpression="recActMonth" />
                                            </Columns>
                                        </asp:GridView>
                                    </ItemTemplate>
                    ...
                    <div>tblRecordDetail - proposeRespPerson_A <asp:Label ID="Label12" runat="server" Text="Label"></asp:Label></div>
                    <asp:SqlDataSource ID="SqlDataSource12" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT DISTINCT proposeRespPerson_A FROM tblRecordDetail WHERE (proposeRespPerson_A &lt;&gt; 0) ORDER BY proposeRespPerson_A"></asp:SqlDataSource>
                    <telerik:RadGrid ID="RadGrid12" runat="server" GroupPanelPosition="Top" Skin="Metro" Height="300px" DataSourceID="SqlDataSource12">
                        <GroupingSettings CollapseAllTooltip="Collapse all groups" />
                        <ClientSettings>
                            <Scrolling AllowScroll="True" UseStaticHeaders="True" />
                        </ClientSettings>
                        <MasterTableView AutoGenerateColumns="False" DataSourceID="SqlDataSource12">
                            <CommandItemSettings ShowExportToExcelButton="false" ShowAddNewRecordButton="false" ShowRefreshButton="false" />
                            <NoRecordsTemplate>
                                <div style="padding: 13px 0 30px 24px">&nbsp;</div>
                            </NoRecordsTemplate>
                            <Columns>
                                <telerik:GridBoundColumn DataField="proposeRespPerson_A" HeaderText="RespPerson_A" UniqueName="proposeRespPerson_A_data" DataType="System.Int32" FilterControlAltText="Filter empId column" SortExpression="proposeRespPerson_A">
                                </telerik:GridBoundColumn>
                                <telerik:GridTemplateColumn DataField="proposeRespPerson_A" DataType="System.Int32" FilterControlAltText="Filter empId column" HeaderText="RespPerson_A" SortExpression="proposeRespPerson_A" UniqueName="proposeRespPerson_A">
                                    <ItemTemplate>
                                        <asp:HiddenField ID="hfEmpId" runat="server" Value='<%# Eval("proposeRespPerson_A") %>' />
                                        <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
                                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT detailId, recId, observItem FROM tblRecordDetail WHERE (proposeRespPerson_A = @empId)">
                                            <SelectParameters>
                                                <asp:ControlParameter ControlID="hfEmpId" Name="empId" PropertyName="Value" />
                                            </SelectParameters>
                                        </asp:SqlDataSource>
                    ...
                    <div>tblRecordDetail - proposeRespPerson_B <asp:Label ID="Label13" runat="server" Text="Label"></asp:Label></div>
                    <asp:SqlDataSource ID="SqlDataSource13" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT DISTINCT proposeRespPerson_B FROM tblRecordDetail WHERE (proposeRespPerson_B &lt;&gt; 0) ORDER BY proposeRespPerson_B"></asp:SqlDataSource>
                    <telerik:RadGrid ID="RadGrid13" runat="server" GroupPanelPosition="Top" Skin="Metro" Height="300px" DataSourceID="SqlDataSource13">
                        <GroupingSettings CollapseAllTooltip="Collapse all groups" />
                        <ClientSettings>
                            <Scrolling AllowScroll="True" UseStaticHeaders="True" />
                        </ClientSettings>
                        <MasterTableView AutoGenerateColumns="False" DataSourceID="SqlDataSource13">
                            <CommandItemSettings ShowExportToExcelButton="false" ShowAddNewRecordButton="false" ShowRefreshButton="false" />
                            <NoRecordsTemplate>
                                <div style="padding: 13px 0 30px 24px">&nbsp;</div>
                            </NoRecordsTemplate>
                            <Columns>
                                <telerik:GridBoundColumn DataField="proposeRespPerson_B" HeaderText="RespPerson_B" UniqueName="proposeRespPerson_B_data" DataType="System.Int32" FilterControlAltText="Filter empId column" SortExpression="proposeRespPerson_B">
                                </telerik:GridBoundColumn>
                                <telerik:GridTemplateColumn DataField="proposeRespPerson_B" DataType="System.Int32" FilterControlAltText="Filter empId column" HeaderText="RespPerson_B" SortExpression="proposeRespPerson_B" UniqueName="proposeRespPerson_B">
                                    <ItemTemplate>
                                        <asp:HiddenField ID="hfEmpId" runat="server" Value='<%# Eval("proposeRespPerson_B") %>' />
                                        <asp:Label ID="Label3" runat="server" Text="Label"></asp:Label>
                                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT detailId, recId, observItem FROM tblRecordDetail WHERE (proposeRespPerson_B = @empId)">
                                            <SelectParameters>
                                                <asp:ControlParameter ControlID="hfEmpId" Name="empId" PropertyName="Value" />
                                            </SelectParameters>
                                        </asp:SqlDataSource>
                    ...
                    <div>tblRecordDetail - proposeRespPerson_C <asp:Label ID="Label14" runat="server" Text="Label"></asp:Label></div>
                    <asp:SqlDataSource ID="SqlDataSource14" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT DISTINCT proposeRespPerson_C FROM tblRecordDetail WHERE (proposeRespPerson_C &lt;&gt; 0) ORDER BY proposeRespPerson_C"></asp:SqlDataSource>
                    <telerik:RadGrid ID="RadGrid14" runat="server" GroupPanelPosition="Top" Skin="Metro" Height="300px" DataSourceID="SqlDataSource14">
                        <GroupingSettings CollapseAllTooltip="Collapse all groups" />
                        <ClientSettings>
                            <Scrolling AllowScroll="True" UseStaticHeaders="True" />
                        </ClientSettings>
                        <MasterTableView AutoGenerateColumns="False" DataSourceID="SqlDataSource14">
                            <CommandItemSettings ShowExportToExcelButton="false" ShowAddNewRecordButton="false" ShowRefreshButton="false" />
                            <NoRecordsTemplate>
                                <div style="padding: 13px 0 30px 24px">&nbsp;</div>
                            </NoRecordsTemplate>
                            <Columns>
                                <telerik:GridBoundColumn DataField="proposeRespPerson_C" HeaderText="RespPerson_C" UniqueName="proposeRespPerson_C_data" DataType="System.Int32" FilterControlAltText="Filter empId column" SortExpression="proposeRespPerson_C">
                                </telerik:GridBoundColumn>
                                <telerik:GridTemplateColumn DataField="proposeRespPerson_C" DataType="System.Int32" FilterControlAltText="Filter empId column" HeaderText="RespPerson_C" SortExpression="proposeRespPerson_C" UniqueName="proposeRespPerson_C">
                                    <ItemTemplate>
                                        <asp:HiddenField ID="hfEmpId" runat="server" Value='<%# Eval("proposeRespPerson_C") %>' />
                                        <asp:Label ID="Label4" runat="server" Text="Label"></asp:Label>
                                        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT detailId, recId, observItem FROM tblRecordDetail WHERE (proposeRespPerson_C = @empId)">
                                            <SelectParameters>
                                                <asp:ControlParameter ControlID="hfEmpId" Name="empId" PropertyName="Value" />
                                            </SelectParameters>
                                        </asp:SqlDataSource>
                    ...
                    <div>tblRecordOthEmpO <asp:Label ID="Label15" runat="server" Text="Label"></asp:Label></div>
                    <asp:SqlDataSource ID="SqlDataSource15" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT DISTINCT empIdOth FROM tblRecordOthEmpO WHERE (empIdOth &lt;&gt; 0) ORDER BY empIdOth"></asp:SqlDataSource>
                    <telerik:RadGrid ID="RadGrid15" runat="server" GroupPanelPosition="Top" Skin="Metro" Height="300px" DataSourceID="SqlDataSource15">
                        <GroupingSettings CollapseAllTooltip="Collapse all groups" />
                        <ClientSettings>
                            <Scrolling AllowScroll="True" UseStaticHeaders="True" />
                        </ClientSettings>
                        <MasterTableView AutoGenerateColumns="False" DataSourceID="SqlDataSource15">
                            <CommandItemSettings ShowExportToExcelButton="false" ShowAddNewRecordButton="false" ShowRefreshButton="false" />
                            <NoRecordsTemplate>
                                <div style="padding: 13px 0 30px 24px">&nbsp;</div>
                            </NoRecordsTemplate>
                            <Columns>
                                <telerik:GridBoundColumn DataField="empIdOth" HeaderText="empIdOth" UniqueName="empIdOth" DataType="System.Int32" FilterControlAltText="Filter empId column" SortExpression="empIdOth">
                                </telerik:GridBoundColumn>
                                <telerik:GridTemplateColumn DataField="empIdOth" DataType="System.Int32" FilterControlAltText="Filter empId column" HeaderText="empIdOth Detail" SortExpression="empIdOth" UniqueName="empIdOth_detail">
                                    <ItemTemplate>
                                        <asp:HiddenField ID="hfEmpId" runat="server" Value='<%# Eval("empIdOth") %>' />
                                        <asp:Label ID="Label5" runat="server" Text="Label"></asp:Label>
                                        <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT recId, recItem FROM tblRecordOthEmpO WHERE empIdOth = @empId">
                                            <SelectParameters>
                                                <asp:ControlParameter ControlID="hfEmpId" Name="empId" PropertyName="Value" />
                                            </SelectParameters>
                                        </asp:SqlDataSource>
                                        <asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource5">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="recItem" HeaderText="recItem" SortExpression="recItem" />
                                            </Columns>
                                        </asp:GridView>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
                ...
                <div class="col-md-12" style="padding: 0px 6px 0px 0px;">
                    ...
                    <asp:SqlDataSource ID="srcGetData" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT dbo.tblRecord.recId, dbo.tblRecord.recActNo, dbo.tblRecord.recActDate, dbo.tblRecord.recActTime, dbo.tblRecord.durationValue, tblObserver1.empFullName, tblObserver1.empDowId, dbo.tblDepartment.departName, dbo.tblRecord.noObserve, (SELECT tblEmployee1a.empFullName FROM dbo.tblRecordOthEmpO AS tblRecordOthEmpO1a INNER JOIN dbo.tblEmployee AS tblEmployee1a ON tblRecordOthEmpO1a.empIdOth = tblEmployee1a.empId WHERE (tblRecordOthEmpO1a.recId = dbo.tblRecord.recId) AND (tblRecordOthEmpO1a.recItem = '1')) AS othNameObs1, (SELECT tblEmployee1b.empDowId FROM dbo.tblRecordOthEmpO AS tblRecordOthEmpO1b INNER JOIN dbo.tblEmployee AS tblEmployee1b ON tblRecordOthEmpO1b.empIdOth = tblEmployee1b.empId WHERE (tblRecordOthEmpO1b.recId = dbo.tblRecord.recId) AND (tblRecordOthEmpO1b.recItem = '1')) AS othDowIdObs1, (SELECT tblDepartment1c.departName FROM dbo.tblRecordOthEmpO AS tblRecordOthEmpO1c INNER JOIN dbo.tblEmployee AS tblEmployee1c ON tblRecordOthEmpO1c.empIdOth = tblEmployee1c.empId INNER JOIN dbo.tblDepartment AS tblDepartment1c ON tblEmployee1c.departId = tblDepartment1c.departId WHERE (tblRecordOthEmpO1c.recId = dbo.tblRecord.recId) AND (tblRecordOthEmpO1c.recItem = '1')) AS othDepartObs1, (SELECT tblEmployee2a.empFullName FROM dbo.tblRecordOthEmpO AS tblRecordOthEmpO2a INNER JOIN dbo.tblEmployee AS tblEmployee2a ON tblRecordOthEmpO2a.empIdOth = tblEmployee2a.empId WHERE (tblRecordOthEmpO2a.recId = dbo.tblRecord.recId) AND (tblRecordOthEmpO2a.recItem = '2')) AS othNameObs2, (SELECT tblEmployee2b.empDowId FROM dbo.tblRecordOthEmpO AS tblRecordOthEmpO2b INNER JOIN dbo.tblEmployee AS tblEmployee2b ON tblRecordOthEmpO2b.empIdOth = tblEmployee2b.empId WHERE (tblRecordOthEmpO2b.recId = dbo.tblRecord.recId) AND (tblRecordOthEmpO2b.recItem = '2')) AS othDowIdObs2, (SELECT tblDepartment2c.departName FROM dbo.tblRecordOthEmpO AS tblRecordOthEmpO2c INNER JOIN dbo.tblEmployee AS tblEmployee2c ON tblRecordOthEmpO2c.empIdOth = tblEmployee2c.empId INNER JOIN dbo.tblDepartment AS tblDepartment2c ON tblEmployee2c.departId = tblDepartment2c.departId WHERE (tblRecordOthEmpO2c.recId = dbo.tblRecord.recId) AND (tblRecordOthEmpO2c.recItem = '2')) AS othDepartObs2, (SELECT tblEmployee3a.empFullName FROM dbo.tblRecordOthEmpO AS tblRecordOthEmpO3a INNER JOIN dbo.tblEmployee AS tblEmployee3a ON tblRecordOthEmpO3a.empIdOth = tblEmployee3a.empId WHERE (tblRecordOthEmpO3a.recId = dbo.tblRecord.recId) AND (tblRecordOthEmpO3a.recItem = '3')) AS othNameObs3, (SELECT tblEmployee3b.empDowId FROM dbo.tblRecordOthEmpO AS tblRecordOthEmpO3b INNER JOIN dbo.tblEmployee AS tblEmployee3b ON tblRecordOthEmpO3b.empIdOth = tblEmployee3b.empId WHERE (tblRecordOthEmpO3b.recId = dbo.tblRecord.recId) AND (tblRecordOthEmpO3b.recItem = '3')) AS othDowIdObs3, (SELECT tblDepartment3c.departName FROM dbo.tblRecordOthEmpO AS tblRecordOthEmpO3c INNER JOIN dbo.tblEmployee AS tblEmployee3c ON tblRecordOthEmpO3c.empIdOth = tblEmployee3c.empId INNER JOIN dbo.tblDepartment AS tblDepartment3c ON tblEmployee3c.departId = tblDepartment3c.departId WHERE (tblRecordOthEmpO3c.recId = dbo.tblRecord.recId) AND (tblRecordOthEmpO3c.recItem = '3')) AS othDepartObs3, (SELECT tblEmployee4a.empFullName FROM dbo.tblRecordOthEmpO AS tblRecordOthEmpO4a INNER JOIN dbo.tblEmployee AS tblEmployee4a ON tblRecordOthEmpO4a.empIdOth = tblEmployee4a.empId WHERE (tblRecordOthEmpO4a.recId = dbo.tblRecord.recId) AND (tblRecordOthEmpO4a.recItem = '4')) AS othNameObs4, (SELECT tblEmployee4b.empDowId FROM dbo.tblRecordOthEmpO AS tblRecordOthEmpO4b INNER JOIN dbo.tblEmployee AS tblEmployee4b ON tblRecordOthEmpO4b.empIdOth = tblEmployee4b.empId WHERE (tblRecordOthEmpO4b.recId = dbo.tblRecord.recId) AND (tblRecordOthEmpO4b.recItem = '4')) AS othDowIdObs4, (SELECT tblDepartment4c.departName FROM dbo.tblRecordOthEmpO AS tblRecordOthEmpO4c INNER JOIN dbo.tblEmployee AS tblEmployee4c ON tblRecordOthEmpO4c.empIdOth = tblEmployee4c.empId INNER JOIN dbo.tblDepartment AS tblDepartment4c ON tblEmployee4c.departId = tblDepartment4c.departId WHERE (tblRecordOthEmpO4c.recId = dbo.tblRecord.recId) AND (tblRecordOthEmpO4c.recItem = '4')) AS othDepartObs4, (SELECT tblEmployee5a.empFullName FROM dbo.tblRecordOthEmpO AS tblRecordOthEmpO5a INNER JOIN dbo.tblEmployee AS tblEmployee5a ON tblRecordOthEmpO5a.empIdOth = tblEmployee5a.empId WHERE (tblRecordOthEmpO5a.recId = dbo.tblRecord.recId) AND (tblRecordOthEmpO5a.recItem = '5')) AS othNameObs5, (SELECT tblEmployee5b.empDowId FROM dbo.tblRecordOthEmpO AS tblRecordOthEmpO5b INNER JOIN dbo.tblEmployee AS tblEmployee5b ON tblRecordOthEmpO5b.empIdOth = tblEmployee5b.empId WHERE (tblRecordOthEmpO5b.recId = dbo.tblRecord.recId) AND (tblRecordOthEmpO5b.recItem = '5')) AS othDowIdObs5, (SELECT tblDepartment5c.departName FROM dbo.tblRecordOthEmpO AS tblRecordOthEmpO5c INNER JOIN dbo.tblEmployee AS tblEmployee5c ON tblRecordOthEmpO5c.empIdOth = tblEmployee5c.empId INNER JOIN dbo.tblDepartment AS tblDepartment5c ON tblEmployee5c.departId = tblDepartment5c.departId WHERE (tblRecordOthEmpO5c.recId = dbo.tblRecord.recId) AND (tblRecordOthEmpO5c.recItem = '5')) AS othDepartObs5 FROM dbo.tblRecord INNER JOIN dbo.tblEmployee AS tblObserver1 ON dbo.tblRecord.empId = tblObserver1.empId INNER JOIN dbo.tblDepartment ON tblObserver1.departId = dbo.tblDepartment.departId WHERE (dbo.tblRecord.recActive = 'true') AND (dbo.tblRecord.recActMonth = @recActMonth) AND (dbo.tblRecord.recActYear = @recActYear) AND (dbo.tblRecord.departId = @departId) ORDER BY dbo.tblRecord.recActNo">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="rcbSelMonth" Name="recActMonth" PropertyName="SelectedValue" />
                            <asp:ControlParameter ControlID="rcbSelYear" Name="recActYear" PropertyName="SelectedValue" />
    ...
    <telerik:RadAjaxLoadingPanel ID="RadAjaxLoadingPanel1" runat="server" Skin="Bootstrap" Transparency="50" MinDisplayTime="400"></telerik:RadAjaxLoadingPanel>
</asp:Content>
