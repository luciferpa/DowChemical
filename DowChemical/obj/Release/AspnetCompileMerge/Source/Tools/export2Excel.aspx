<%@ Page Title="Home Page" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="export2Excel.aspx.vb" Inherits="DowChemical.export2Excel" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="col-md-12" style="padding: 0px 6px 0px 0px;">
                    ...
                    <div class="row">
                        <div class="pull-right" style="padding-top: 2px;">
                            <asp:Button ID="btSupportTools" runat="server" class="btn btn-xs btn-default" Text="Show Support Tools" Width="160px" />
                        </div>
                    </div>
                    <asp:Panel ID="pnSupportTools" runat="server" Visible="false">
                        <div style="padding-top: 0px;">
                            <div> Query String</div>
                            <asp:TextBox ID="tbShowQuery" runat="server" TextMode="MultiLine" Height="100px" Width="100%"></asp:TextBox>
                        </div>
                        <div style="padding-top: 8px;">
                            <div style="display: block; float: left; width: 228px;">
                                <asp:Button ID="btShowQuery" runat="server" class="btn btn-xs btn-default" Text="Valify No.Observe VS RecordDetail" Width="220px" />
                            </div>
                            <div style="display: block; float: left; width: 228px;">
                            </div>
                        </div>
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="btSupportTools">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="pnSupportTools" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
